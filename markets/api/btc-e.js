...
/**
 * OrderInfo: returns information about order.
 ...
 * @param {Function} callback(err, data)
 */
BTCE.prototype.orderInfo = function(orderId, callback) {
    this.query("OrderInfo", { "order_id": orderId }, callback);
};
...
BTCE.prototype.query = function(method, params, callback) {
  var content = {
    "method": method,
    //"nonce": ++this.nonce,
    "nonce": BTCE.getTimestamp(Date.now())
  };
...
BTCE.prototype.trades = function(params, callback) {
  ...
  var url = this.urlGet+"trades/"+params.pair+"/"+params.count;
...
BTCE.prototype.depth = function(params, callback) {
  ...
  var url = this.urlGet+"depth/"+params.pair+"?limit="+params.limit;
